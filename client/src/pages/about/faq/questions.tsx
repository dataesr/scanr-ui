export const questions = [
  ...
  },
  {
    ...
    definition: {
      ...
      en: 'scanR focuses on 4 main types of "Objects": <b>entities</b>, <b>projects</b>, <b>persons</b> and <b>productions</b> (publications, PhD thesis and patents).<br></br>Among the "entities", scanR covers all the research structures referenced in the National Directory of Research Structures (RNSR) as well as their institutions. It also covers, in the most comprehensive way possible, all public or private institutions, whether profit-making or not, mentioned in the main sources mobilized.<br></br>scanR covers a set of "Projects" that correspond to research works that have been the subject of French public funding or not insofar as an open and reusable source exists (see FAQ <linkQuestion>q18:::What are the funding identified in scanR?</linkQuestion>).<br></br>scanR covers authors with an Idref identifier (see FAQ <linkQuestion>q27:::Which authors have an author profile in scanR?</linkQuestion>) for whom at least one link to another source (RNSR, production, project) could be established. To avoid errors, scanR excludes homonymous authors. On request and with additional information, scanR can introduce them individually.<br></br>scanR covers publications (see FAQ <linkQuestion>q31:::What is the scope of research publications (articles, theses, monographs) presented in scanR?</linkQuestion>) since 2013, a selection of books and monographs, theses since 1990, patents since 2013.',
    },
  ...
  },
  {
    ...
    definition: {
      fr: "<b>Oui</b>, il peut y en avoir.<br></br>Comme tout outil mobilisant une quantité massive d'informations hétérogènes, scanR peut présenter des erreurs, des omissions, des imprécisions. Celles-ci peuvent provenir de différentes origines (internes, liées aux sources ou aux référentiels, voir FAQ <linkQuestion>q10:::\"D'où proviennent les erreurs que l'on peut constater dans scanR ?\"</linkQuestion>).<br></br>Cependant, l'objectif de scanR n'est pas la production de métriques. scanR vise à fournir, sur la base d'informations ouvertes et réutilisables, des indications proches de la réalité sur les orientations des laboratoires et institutions publiques, des entreprises en matière de recherche et d'innovation. Il s'agit de valoriser les travaux conduits dans les laboratories, de rendre compte à tous de travaux largement conduits sur la base de financements publics, de contribuer à l'appropriation par tous, notamment dans le débat public, des connaissances scientifiques actuelles, de faciliter les mises en relations pour dynamiser cette activité en France.<br></br>Dans ces conditions, l'erreur, assumée et traitée, est tolérée. Cette visibilité de l'erreur est ainsi perçue comme facteur d'amélioration de la qualité.<br></br>En soumettant aux utilisateurs, often the meilleurs connaisseurs des réalités de terrain, l'information telle qu'elle est et non telle qu'on s'attend à ce qu'elle soit, et en leur donnant la possibilité d'effectuer des signalements, il s'agit:<br></br>(1) d'inciter l'équipe de scanR à demeurer dans une démarche d'amélioration continue de ses processus<br></br>(2) de contribuer à l'amélioration des sources et référentiels eux-mêmes.<br></br>Ainsi, les signalements réalisés par les utilisateurs de scanR sont traités systématiquement. Quand l'erreur relève de la qualité des sources et référentiels, suivant le cas, le signalement est reporté directement au responsable de la source ou l'utilisateur est orienté vers le responsable de la source ou un correspondant local qui effectuera les ajustements nécessaires ou accompagnera l'utilisateur pour les réaliser.<br></br>Vous avez constaté une erreur ? Dites le nous !",
      en: "<b>Yes</b>, there may be.<br></br>Like any tool that mobilizes a massive amount of heterogeneous information, scanR can contain errors, omissions and inaccuracies. These can come from different origins (internal, source-related or repository-related, see FAQ <linkQuestion>q10:::Where do the errors in scanR come from?</linkQuestion>).<br></br>However, the objective of scanR is not the production of metrics. scanR aims to provide, on the basis of open and reusable information, realistic indications on the orientations of public laboratories and institutions, companies in terms of research and innovation. The aim is to enhance the value of the work carried out in the laboratories, to report to everyone on work largely carried out on the basis of public funding, to make current scientific knowledge accessible to everyone, particularly in the public debate, and to facilitate networking to boost this activity in France.<br></br>Under these conditions, the error, assumed and processed, is tolerated. This visibility of error is thus perceived as a factor in improving quality.<br></br>scanR offers its users, often the best experts in the field, information as it is and not as it is expected to be. By giving them the opportunity to report, the goal is:<br></br>(1) to encourage the scanR team to remain in a process of continuous improvement of its processes<br></br>(2) to contribute to the improvement of the sources and repositories themselves.<br></br>Thus, reports made by scanR users are systematically processed. When the error is related to the quality of sources and repositories, as the case may be, the report is reported directly to the source manager or the user is directed to the source manager or a local correspondent who will make the necessary adjustments or accompany the user to make them.<br></br>Did you notice an error? Tell us about it!",
    },
  },
  {
    key: "q8",
  ...
  },
  {
    ...
    definition: {
      ...
      en: 'Three main factors of errors, inaccuracies and omissions influence the quality of scanR data: the quality of the processing performed by scanR, the quality of the sources and the quality of the repositories that describe the "objects" presented in scanR (entities, persons, projects, productions).<br></br>Even if scanR constantly adapts its methods and tools to limit its internal errors, newly identified difficulties, coding errors, unidentified features can lead to errors or omissions in the returned data.<br></br>But scanR errors can come from two other sources, independent of the information processing work performed by scanR:<br></br>(1) Source quality: few sources mobilized by scanR systematically integrate an interoperable identifier. When this is the case, they may also contain errors and omissions.<br></br>Beyond the insufficient presence of identifiers, the information provided by some source records can be very imprecise, incomplete, ambiguous or truncated<br></br>(2) the quality of the repositories. the repositories also contain errors, inaccuracies and omissions. Objects may be missing. Strings relating to the naming of objects (entities, persons, projects, productions) may be incomplete, ambiguous, truncated, erroneous. The history of objects in repositories may only be partially filled in. Repositories can evolve with delay in relation to the reality they must report on.',
    },
  },
  {
    key: "q11",
  ...
  },
  {
    ...
    definition: {
      fr: "Malgré les efforts de scanR, des doublons peuvent de manière marginale exister. Une même entité ou une même production peut apparaitre ainsi plusieurs fois dans des résultats de recherche. Quelle est l'origine de cette situation?<br></br>Les différents acteurs de la recherche relèvent de structures de nature juridique variable, de niveaux de granularitées très différents. Ils relèvent de différents référentiels non mutuellement exclusifs. Une entité ou une production peut ainsi apparaître dans plusieurs référentiels. Dans la gestion de ces référentiels, scanR veille au maximum à éviter ces doublons et à identifier les zones de recouvrement. Cependant, leur détection est parfois complexe compte tenu des spécificités des différents référentiels d'où l'existence de certains doublons.<br></br>Vous en avez identifiés ? Dites le nous, nous ajusterons nos données ?",
      en: "Despite the efforts of scanR, duplicates may exist in a marginal way. The same entity or production may thus appear several times in search results. What is the origin of this situation?<br></br>The various research actors have different legal structures and very different levels of granularity. They are subject to different, not mutually exclusive, repositories. An entity or a production can thus appear in several repositories. In managing these repositories, scanR takes great care to avoid these duplicates and to identify overlapping areas. However, their detection is sometimes complex given the specificities of the different repositories.<br></br>Have you identified any of them? Tell us, will we adjust our data?",
    },
  },
  {
    key: "q16",
  ...
  },
  {
    ...
    definition: {
      fr: "Vous avez reçu un prix ou une distinction pour vos travaux de recherche mais scanR ne mentionne pas cette récompense ? Signalez-le nous [lien rubrique contact] et aidez nous à convaincre l'institution qui vous l'a décerné de verser régulièrement la liste de ses lauréats à scanR !<br></br>Votre entreprise, fondation, association, institution publique décerne des prix et distinctions à des acteurs de la recherche ? Vous souhaitez apparaître dans scanR pour renforcer la reconnaissance de votre action au côté de la recherche française ? <link>contact:::Contactez nous</link>   !",
      en: "You have received a scientific prize but scanR does not mention this award? Please let us know[link to contact section] and help us convince the institution that awarded you to regularly send the list of its winners to scanR!<br></br>Does your company, foundation, association, public institution award prizes and distinctions to research actors? Would you like to appear in scanR to strengthen the recognition of your action alongside French research?  <link>contact:::Contact us</link>  !",
    },
  },
  {
    key: "q25",
  ...
  },
  {
    ...
    definition: {
      fr: "Vous souhaitez ne plus figurer en tant qu'auteur dans scanR ?<br></br>Parce que scanR ne référence que trop peu de vos travaux ? Nous pouvons arranger cela ensemble. Sur votre page-auteur, cliquez sur 'lier des publications' et suggérez à scanR des publications à associer à votre page-auteur. Vous pouvez aussi signaler une erreur sur votre fiche-auteur ou nous communiquer des informations complémentaires permettant de l'améliorer (identifiant HAL, Orcid), cliquez sur 'signaler une erreur'. Nous ferons le nécessaire.<br></br>Pour une toute autre raison, vous ne souhaitez plus faire apparaître votre profil-auteur dans scanR. Dans ce cas, nous supprimerons votre profil. Vos travaux resteront cependant accessibles via une recherche mais ils ne seront plus associés à un profil auteur à votre nom.",
      en: "Do you no longer want to have an author profile in scanR?<br></br>Because scanR only refers to too little of your work? We can arrange this together. Contact us by copying and pasting the scanR address of your page from your browser, give us the list of DOIs of your publications or their HAL identifier or the reference in SUDOC or in theses.fr. We will handle it.<br></br>- For another reason, you no longer want your author profile to appear in scanR. In this case, we will delete your profile. However, your works will remain accessible via a search but they will no longer be associated with an author profile in your name.",
    },
  },
  {
    key: "q30",
  ...
  },
  {
    ...
    definition: {
      ...
      en: 'scanR can reference a publication but be unable to link it to an author profile. Homonymies and lack of author-profile in the repositories are the main causes of this situation.<br></br>If you have a homonym, provide us with your idref identifier and, if possible, the list of DOIs for your work (or their Sudoc identifiers) and we will do the necessary.<br></br>If you do not have an Idref identifier, contact your correspondent "Scientific Information" in the university library or in your documentation centre. And at the same time, think about creating your international ORCID author ID and linking your ORCID profile to your new Idref ID!',
    },
  },
  {
    key: "q37",
  ...
  },
  {
    ...
    definition: {
      fr: "Les inventions correspondent ici aux familles de brevets simples au sens de l’OEB. Une famille de brevets simple est une collection de dépôts de brevets considérés comme couvrant une seule invention : leur contenu technique est réputé identique et ils ont tous exactement les mêmes priorités.<br></br>En effet, un brevet ne protégeant que sur un territoire déterminé, il est nécessaire de déposer une demande de brevet dans toutes les juridictions où l'on souhaite être protégé. Des procédures facilitent la démarche, mais au final elles donnent lieu à un ensemble de dépôts dans divers offices nationaux ou régionaux, que l'on regroupe dans ce que l'on appelle la famille de brevets.<br></br><link>https://www.epo.org/searching-for-patents/helpful-resources/first-time-here/patent-families_fr.html:::En savoir plus sur les familles de brevets</link>",
      en: "The inventions here mean EPO’s simple patent families. A simple patent family is a collection of patent documents that are considered to cover a single invention : their technical content is considered to be identical and they all have exactly the same priorities.<br></br>Indeed, patent protection is territorial and inventors and investors may have to seek protection in various different jurisdictions. Procedures facilitate the process, but ultimately they give rise to a set of filings in various national or regional offices, which are grouped in what is called the patent family.<br></br><link>https://www.epo.org/searching-for-patents/helpful-resources/first-time-here/patent-families_fr.html:::Learn more about patent families</link>",
    },
  },
  {
    key: "q46",
  ...
  },
  {
    ...
    definition: {
      fr: "Une demande de brevet nationale est effectuée au sein d'un office national et délivre des brevets  protégeant sur le territoire national.<br></br>Le PCT est un traité international qui compte plus de 150 États contractants. Ce traité permet d’obtenir simultanément la protection d’une invention dans un grand nombre de pays en déposant une demande “internationale” unique au lieu de déposer plusieurs demandes de brevet nationales ou régionales distinctes. La délivrance des brevets reste sous le contrôle des offices de brevets nationaux ou régionaux dans ce qu’il est convenu d’appeler la “phase nationale”.<br></br>Une demande régionale est une demande effectuée auprès d'un office régional : la demande peut être effectuée directement auprès de l'office régional ou bien elle est faite par désignation lors de la procédure du PCT.<br></br><link>https://www.wipo.int/pct/en/faqs/faqs.html:::En savoir plus sur la procédure PCT</link>",
      en: "A national patent application is filed at a national office and grants patents protecting on the national territory.<br></br>The PCT is an international treaty with more than 150 Contracting States. The PCT makes it possible to seek patent protection for an invention simultaneously in a large number of countries by filing a single “international” patent application instead of filing several separate national or regional patent applications. The granting of patents remains under the control of the national or regional patent Offices in what is called the “national phase”.<br></br>A regional application is an application filed with a regional office: the application may be filed directly with the regional office or it may be filed by designation during the PCT procedure.<br></br><link>https://www.wipo.int/pct/en/faqs/faqs.html:::Learn more about the International Patent System</link>",
    },
  },
  {
    key: "q55",
    ...
    definition: {
      ...
      en: "Horizon Europe is the European Union's framework programme for research and innovation for the 2021–2027 period. It succeeds the Horizon 2020 programme, which ended at the close of 2020. It has a budget of approximately €95.5 billion for 2021–2027 (in current prices). The Horizon Europe framework programme is built on four pillars: Excellent Science; Global Challenges and European Industrial Competitiveness; Innovative Europe; and Widening Participation and Strengthening the European Research Area."
    },
  },
  {
    key: "q56",
  ...
  },
  {
    ...
    definition: {
      fr: "<link>https://www.vosviewer.com:::VosViewer</link> est un logiciel développé par <link>https://www.cwts.nl:::CWTS</link> (<link>https://www.universiteitleiden.nl/en:::Université de Leiden</link>), spécialisé dans la visualisation et l'analyse de réseaux, particulièrement utilisé dans le domaine de la recherche scientifique.<br></br>Nous utilisons cet outil pour visualiser les réseaux de manière interactive, offrant ainsi une compréhension approfondie des structures et des tendances au sein de vastes ensembles de données bibliographiques.",
  ...
  },
  {
    ...
    definition: {
      fr: "<imgInsert>/img/callon_quadrants.png:::Les quatres quadrants du diagramme stratégique</imgInsert>Le diagramme stratégique est centré sur les médianes de centralité et de densité, ce qui divise naturellement l'espace en quatre quadrants :<br></br><ul><li><b>Thèmes moteurs (en haut à droite)</b><br></br>Haute centralité, haute densité. Ces thèmes sont à la fois bien développés en interne et centraux dans le réseau. Ils représentent les axes de recherche principaux et structurants du domaine.</li><br></br><li><b>Thèmes de niche ou isolés (en haut à gauche)</b><br></br>Basse centralité, haute densité. Ces thèmes sont très développés en interne mais peu connectés au reste du réseau. Ils peuvent représenter des domaines spécialisés ou des thématiques périphériques bien établies.</li><br></br><li><b>Thèmes émergents ou en déclin (en bas à gauche)</b><br></br>Basse centralité, basse densité. Ces thèmes sont peu développés et peu connectés. Ils peuvent correspondre à des sujets émergents en cours de structuration ou à des thématiques en déclin.</li><br></br><li><b>Thèmes basiques et transversaux (en bas à droite)</b><br></br>Haute centralité, basse densité. Ces thèmes sont centraux dans le réseau mais moins développés en interne. Ils constituent souvent des fondements méthodologiques ou des thèmes transversaux qui irriguent plusieurs domaines.</li></ul><br></br><h3>Interprétation visuelle du diagramme stratégique</h3><imgInsert>/img/callon_quadrants_1.png:::Catégorie 1: Cette configuration reflète un domaine mature et stable. La majorité de l'activité de recherche gravite autour d'un ensemble limité de thèmes centraux et fortement structurés.</imgInsert><imgInsert>/img/callon_quadrants_2.png:::Catégorie 2: Les thèmes sont organisés de manière irrégulière, avec peu de convergence vers une structure dominante. Le domaine apparaît polycentrique et dynamiquement évoluant.</imgInsert><imgInsert>/img/callon_quadrants_3.png:::Catégorie 3: Cette configuration est charactérisée une structure riche et complexe, avec tous les degrés de developpement présents et suggère une dynamique importante du domaine.</imgInsert>",
      en: "<imgInsert>/img/callon_quadrants.png:::The four quadrants of the strategic diagram</imgInsert>The strategic diagram is centered on the medians of centrality and density, which naturally divides the space into four quadrants:<br></br><ul><li><b>Motor themes (top right)</b><br></br>High centrality, high density. These themes are both well-developed internally and central in the network. They represent the main and structuring research axes  of the field.</li><br></br><li><b>Niche or isolated themes (top left)</b><br></br>Low centrality, high density. These themes are highly developed internally but poorly connected to the rest of the network. They may represent specialized domains or well-established peripheral topics.</li><br></br><li><b>Emerging or declining themes (bottom left)</b><br></br>Low centrality, low density. These themes are underdeveloped and poorly connected. They may correspond to emerging subjects in the process of structuring or to declining themes.</li><br></br><li><b>Basic and transversal themes (bottom right)</b><br></br>High centrality, low density. These themes are central in the network but less developed internally. They often constitute methodological foundations or cross-cutting themes that permeate several domains.</li></ul><br></br><h3>Interpretation of the strategic diagram</h3><imgInsert>/img/callon_quadrants_1.png:::Category 1: This configuration reflects a mature and stable domain. Most of the research activity gravitates around a limited set of central and strongly structured themes.</imgInsert><imgInsert>/img/callon_quadrants_2.png:::Category 2: Themes are unevenly organized, with little convergence toward a dominant structure. The field appears polycentric and dynamically evolving.</imgInsert><imgInsert>/img/callon_quadrants_3.png:::Category 3: This configuration characterizes a complex and rich domain with multiple levels of thematic development. No single structure dominates the organization of research.</imgInsert>",
    },
  },
  {
    key: "q66",
