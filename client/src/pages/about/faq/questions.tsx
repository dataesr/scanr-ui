export const questions = [
  ...
  },
  {
    ...
    definition: {
      fr: "Le diagramme stratégique est centré sur les médianes de centralité et de densité, ce qui divise naturellement l'espace en quatre quadrants :<br></br><br></br><ul><li><h3>Thèmes moteurs (en haut à droite)</h3>Haute centralité, haute densité. Ces thèmes sont à la fois bien développés en interne et centraux dans le réseau. Ils représentent les axes de recherche principaux et structurants du domaine.</li><br></br><li><h3>Thèmes de niche ou isolés (en haut à gauche)</h3>Basse centralité, haute densité. Ces thèmes sont très développés en interne mais peu connectés au reste du réseau. Ils peuvent représenter des domaines spécialisés ou des thématiques périphériques bien établies.</li><br></br><li><h3>Thèmes émergents ou en déclin (en bas à gauche)</h3>Basse centralité, basse densité. Ces thèmes sont peu développés et peu connectés. Ils peuvent correspondre à des sujets émergents en cours de structuration ou à des thématiques en déclin.</li><br></br><li><h3>Thèmes basiques et transversaux (en bas à droite)</h3>Haute centralité, basse densité. Ces thèmes sont centraux dans le réseau mais moins développés en interne. Ils constituent souvent des fondements méthodologiques ou des thèmes transversaux qui irriguent plusieurs domaines.</li></ul>",
      en: "The strategic diagram is centered on the medians of centrality and density, which naturally divides the space into four quadrants:<br></br><br></br><ul><li><h3>Motor themes (top right)</h3>High centrality, high density. These themes are both well-developed internally and central in the network. They represent the main and structuring research axes  of the field.</li><br></br><li><h3>Niche or isolated themes (top left)</h3>Low centrality, high density. These themes are highly developed internally but poorly connected to the rest of the network. They may represent specialized domains or well-established peripheral topics.</li><br></br><li><h3>Emerging or declining themes (bottom left)</h3>Low centrality, low density. These themes are underdeveloped and poorly connected. They may correspond to emerging subjects in the process of structuring or to declining themes.</li><br></br><li><h3>Basic and transversal themes (bottom right)</h3>High centrality, low density. These themes are central in the network but less developed internally. They often constitute methodological foundations or cross-cutting themes that permeate several domains.</li></ul>",
    },
  },
  {
    key: "q62",
