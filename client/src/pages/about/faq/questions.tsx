export const questions = [
  ...
  },
  {
    ...
    definition: {
      fr: "<b>Non</b>, scanR n'est pas exhaustif dans ses repérages. scanR peut comporter des erreurs et des omissions (voir FAQ <linkQuestion>q7:::Peut-il y avoir des erreurs dans scanR ?</linkQuestion> ) et ne traite que des sources ouvertes et réutilisables.",
      en: "<b>No</b>, scanR is not exhaustive in its tracking. scanR may contain errors and omissions (see FAQ <linkQuestion>q7:::Can there be errors in scanR?</linkQuestion>) and only deals with open and reusable sources.",
    },
  },
  {
    key: "q4",
    ...
    definition: {
      fr: "scanR s'intéresse à 5 types d'Objets principaux : les <b>entités</b>, les <b>projets</b>, les <b>auteurs</b> et les <b>publications</b> (publications scientifiques, thèses, ouvrages et monographies) et les <b>brevets</b>. Parmi les entités, scanR couvre l'ensemble des structures de recherche référencées dans le Répertoire national des structures de recherche (RNSR) ainsi que leur tutelle. Il couvre également, de la manière la plus complète possible, l'ensemble des institutions publiques ou privées, avec ou sans but lucratif mentionnées dans les principales sources mobilisées. scanR couvre un ensemble de Projets qui correspondent à des travaux de recherche qui ont fait l'objet d'un financement public français ou non dans la mesure où une source ouverte et réutilisable existe (voir FAQ <linkQuestion>q18:::Quels sont les financements recensés dans scanR ?</linkQuestion>). scanR couvre les auteurs disposant d'un identifiant Idref (voir FAQ <linkQuestion>q27:::Quels auteurs disposent d'un profil-auteur dans scanR ?</linkQuestion>) pour lesquels au moins un lien vers une autre source (RNSR, publication, brevet, projet) a pu être établi. Pour éviter les erreurs, scanR exclut les auteurs homonymes. Sur demande et en disposant d'informations complémentaires, scanR pourra les introduire individuellement. Sur demande, scanR pourra également supprimer une fiche auteur sans pour autant supprimer les travaux qui lui étaient associés scanR couvre les publications (voir FAQ <linkQuestion>q31:::Quel est le périmètre des publications de recherche (articles, thèses, monographies) présenté dans scanR ?</linkQuestion>) depuis 2013, une sélection d'ouvrages et de monographies, les thèses depuis 1990, les brevets depuis 2013.",
      en: 'scanR focuses on 4 main types of "Objects": <b>entities</b>, <b>projects</b>, <b>persons</b> and <b>productions</b> (publications, PhD thesis and patents).<br>Among the "entities", scanR covers all the research structures referenced in the National Directory of Research Structures (RNSR) as well as their institutions. It also covers, in the most comprehensive way possible, all public or private institutions, whether profit-making or not, mentioned in the main sources mobilized.<br>scanR covers a set of "Projects" that correspond to research works that have been the subject of French public funding or not insofar as an open and reusable source exists (see FAQ <linkQuestion>q18:::What are the funding identified in scanR?</linkQuestion>).<br>scanR covers authors with an Idref identifier (see FAQ <linkQuestion>q27:::Which authors have an author profile in scanR?</linkQuestion>) for whom at least one link to another source (RNSR, production, project) could be established. To avoid errors, scanR excludes homonymous authors. On request and with additional information, scanR can introduce them individually.<br>scanR covers publications (see FAQ <linkQuestion>q31:::What is the scope of research publications (articles, theses, monographs) presented in scanR?</linkQuestion>) since 2013, a selection of books and monographs, theses since 1990, patents since 2013.',
    },
  ...
  },
  {
    ...
    definition: {
      fr: "<b>Non</b>, car scanR est conçu avant tout comme un outil d'exploration de la recherche et de l'innovation en France. scanR est un outil ouvert, accessible à tous y compris aux institutions en charge de l'évaluation ou de l'allocation de crédits. Dans la limite de ses moyens, scanR est transparent sur les conditions d'élaboration de l'information et considère ses utilisateurs comme responsables des usages qu'ils font de la solution proposée (voir FAQ, glossaire et éléments d'information sur chaque page de l'application).<br>L'équipe en charge de scanR estime que l'application ne peut que constituer un outil de dialogue qualitatif et personnalisé sur les activités de recherche et d'innovation d'une entité ou d'un auteur.",
      en: "<b>No</b>, because scanR is designed above all as a tool for exploring research and innovation in France. scanR is an open tool, accessible to everyone, including institutions in charge of evaluation or funding. Within the limits of its resources, scanR is transparent about the conditions under which the information is prepared and considers its users to be responsible for the uses they make of the proposed solution (see FAQ, glossary and information elements on each page of the application).<br>The scanR team believes that the application can only be a tool for qualitative and personalized dialogue on the research and innovation activities of an entity or author.",
    },
  },
  {
    key: "q6",
  ...
  },
  {
    ...
    definition: {
      fr: "<b>Oui</b>, il peut y en avoir.<br>Comme tout outil mobilisant une quantité massive d'informations hétérogènes, scanR peut présenter des erreurs, des omissions, des imprécisions. Celles-ci peuvent provenir de différentes origines (internes, liées aux sources ou aux référentiels, voir FAQ <linkQuestion>q10:::\"D'où proviennent les erreurs que l'on peut constater dans scanR ?\"</linkQuestion>).<br>Cependant, l'objectif de scanR n'est pas la production de métriques. scanR vise à fournir, sur la base d'informations ouvertes et réutilisables, des indications proches de la réalité sur les orientations des laboratoires et institutions publiques, des entreprises en matière de recherche et d'innovation. Il s'agit de valoriser les travaux conduits dans les laboratories, de rendre compte à tous de travaux largement conduits sur la base de financements publics, de contribuer à l'appropriation par tous, notamment dans le débat public, des connaissances scientifiques actuelles, de faciliter les mises en relations pour dynamiser cette activité en France.<br>Dans ces conditions, l'erreur, assumée et traitée, est tolérée. Cette visibilité de l'erreur est ainsi perçue comme facteur d'amélioration de la qualité.<br>En soumettant aux utilisateurs, often the meilleurs connaisseurs des réalités de terrain, l'information telle qu'elle est et non telle qu'on s'attend à ce qu'elle soit, et en leur donnant la possibilité d'effectuer des signalements, il s'agit:<br>(1) d'inciter l'équipe de scanR à demeurer dans une démarche d'amélioration continue de ses processus<br>(2) de contribuer à l'amélioration des sources et référentiels eux-mêmes.<br>Ainsi, les signalements réalisés par les utilisateurs de scanR sont traités systématiquement. Quand l'erreur relève de la qualité des sources et référentiels, suivant le cas, le signalement est reporté directement au responsable de la source ou l'utilisateur est orienté vers le responsable de la source ou un correspondant local qui effectuera les ajustements nécessaires ou accompagnera l'utilisateur pour les réaliser.<br>Vous avez constaté une erreur ? Dites le nous !",
      en: "<b>Yes</b>, there may be.<br>Like any tool that mobilizes a massive amount of heterogeneous information, scanR can contain errors, omissions and inaccuracies. These can come from different origins (internal, source-related or repository-related, see FAQ <linkQuestion>q10:::Where do the errors in scanR come from?</linkQuestion>).<br>However, the objective of scanR is not the production of metrics. scanR aims to provide, on the basis of open and reusable information, realistic indications on the orientations of public laboratories and institutions, companies in terms of research and innovation. The aim is to enhance the value of the work carried out in the laboratories, to report to everyone on work largely carried out on the basis of public funding, to make current scientific knowledge accessible to everyone, particularly in the public debate, and to facilitate networking to boost this activity in France.<br>Under these conditions, the error, assumed and processed, is tolerated. This visibility of error is thus perceived as a factor in improving quality.<br>scanR offers its users, often the best experts in the field, information as it is and not as it is expected to be. By giving them the opportunity to report, the goal is:<br>(1) to encourage the scanR team to remain in a process of continuous improvement of its processes<br>(2) to contribute to the improvement of the sources and repositories themselves.<br>Thus, reports made by scanR users are systematically processed. When the error is related to the quality of sources and repositories, as the case may be, the report is reported directly to the source manager or the user is directed to the source manager or a local correspondent who will make the necessary adjustments or accompany the user to make them.<br>Did you notice an error? Tell us about it!",
    },
  },
  {
    key: "q8",
  ...
  },
  {
    ...
    definition: {
      fr: "Trois principaux facteurs d'erreurs, d'imprécision et d'omission influencent la qualité des données de scanR : la qualité des traitements réalisés par scanR, celle des sources et celles des référentiels qui décrivent les 'objets' présentés dans scanR (entités, auteurs, projets, productions).<br>Même si scanR s'attache en permanence à adapter ses méthodes et outils pour limiter ses erreurs internes, palier des difficultés nouvellement identifiées, des erreurs de codage, des particularités non identifiées peuvent entraîner des erreurs ou des omissions dans les données restituées. Mais les erreurs de scanR peuvent provenir de deux autres origines, indépendantes des travaux de traitement de l'information réalisés par scanR : (1) la qualité des sources : rares sont les sources mobilisées par scanR qui intègrent systématiquement un identifiant interopérable.<br>Quand c'est le cas, elles peuvent, elles aussi, comporter des erreurs et des omissions. Au-delà de la présence insuffisante des identifiants, l'information portée par certains enregistrements des sources peut être très imprécise, incomplète, ambigüe ou tronquée ;(2) la qualité des référentiels : les référentiels sont également porteurs d'erreurs, d'imprécisions, d'omissions.<br>Des objets peuvent en être absents. Les chaînes de caractères relatives au nommage des objets (entités, auteurs, projets, publications, brevets) peuvent être incomplètes, ambigües, tronquées, erronées. L'historique des objets dans les référentiels peut n'être que partiellement renseigné. Les référentiels peuvent évoluer avec retard par rapport à la réalité dont ils doivent rendre compte.",
      en: 'Three main factors of errors, inaccuracies and omissions influence the quality of scanR data: the quality of the processing performed by scanR, the quality of the sources and the quality of the repositories that describe the "objects" presented in scanR (entities, persons, projects, productions).<br>Even if scanR constantly adapts its methods and tools to limit its internal errors, newly identified difficulties, coding errors, unidentified features can lead to errors or omissions in the returned data.<br>But scanR errors can come from two other sources, independent of the information processing work performed by scanR:<br>(1) Source quality: few sources mobilized by scanR systematically integrate an interoperable identifier. When this is the case, they may also contain errors and omissions.<br>Beyond the insufficient presence of identifiers, the information provided by some source records can be very imprecise, incomplete, ambiguous or truncated<br>(2) the quality of the repositories. the repositories also contain errors, inaccuracies and omissions. Objects may be missing. Strings relating to the naming of objects (entities, persons, projects, productions) may be incomplete, ambiguous, truncated, erroneous. The history of objects in repositories may only be partially filled in. Repositories can evolve with delay in relation to the reality they must report on.',
    },
  },
  {
    key: "q11",
    ...
    definition: {
      fr: "scanR utilise le moteur de recherche <link>https://www.elastic.co/:::Elasticsearch</link>. Il est possible à l'utilisateur de construire une requête complexe pour générer des résultats plus adaptés à une question spécifique. Les opérateurs disponibles sont le '+' (et), le '-' (négation) et le '|' (ou). Par exemple, pour faire une recherche bilingue sur le changement climatique, la requête (changement+climatique) | (climate+change) pourra être utilisée. Concernant la négation, le '-' doit être placé directement avant le mot interdit, sans espace.",
      en: 'scanR uses the <link>https://www.elastic.co/:::Elasticsearch</link> search engine. It is possible for the user to build a complex query to generate results that are more relevant to a specific question.<br>The available operators are "+" (and), "-" ( negation) and "|" (or). For example, to do a bilingual research on climate change, the query (changement+climatique) | (climate+change) could be used. Concerning the negation, the "-" must be placed directly before the forbidden word, without space.',
    },
  },
  {
    key: "q12",
  ...
  },
  {
    ...
    definition: {
      fr: "Malgré les efforts de scanR, des doublons peuvent de manière marginale exister. Une même entité ou une même production peut apparaitre ainsi plusieurs fois dans des résultats de recherche. Quelle est l'origine de cette situation?<br>Les différents acteurs de la recherche relèvent de structures de nature juridique variable, de niveaux de granularitées très différents. Ils relèvent de différents référentiels non mutuellement exclusifs. Une entité ou une production peut ainsi apparaître dans plusieurs référentiels. Dans la gestion de ces référentiels, scanR veille au maximum à éviter ces doublons et à identifier les zones de recouvrement. Cependant, leur détection est parfois complexe compte tenu des spécificités des différents référentiels d'où l'existence de certains doublons.<br>Vous en avez identifiés ? Dites le nous, nous ajusterons nos données ?",
      en: "Despite the efforts of scanR, duplicates may exist in a marginal way. The same entity or production may thus appear several times in search results. What is the origin of this situation?<br>The various research actors have different legal structures and very different levels of granularity. They are subject to different, not mutually exclusive, repositories. An entity or a production can thus appear in several repositories. In managing these repositories, scanR takes great care to avoid these duplicates and to identify overlapping areas. However, their detection is sometimes complex given the specificities of the different repositories.<br>Have you identified any of them? Tell us, will we adjust our data?",
    },
  },
  {
    key: "q16",
  ...
  },
  {
    ...
    definition: {
      fr: "Deux solutions pour contribuer à l'amélioration de scanR :<br><ul><li>Vous avez identifié une erreur, une omission sur une fiche entité, auteur, production ou financement particulière ? Utilisez le bouton \"Contribuer\" pour nous contacter !</li><li>Des remarques générales sur scanR, des idées de sources à intégrer, de propositions d'évolutions de l'interface, des envies de partenriats et de collaboration avec l'équipe ? Rendez-vous à la rubrique <link>contact:::Contact</link>. </li></ul>",
      en: 'Two solutions to contribute to the improvement of scanR:<br><ul><li> Have you identified an error or omission on a particular entity, author, production or funding record? Use the "Contribute" button to contact us !</li><li>General remarks on scanR, ideas of sources to integrate, proposals for evolutions of the interface, desires of partnerships and collaboration with the team? Go to the <link>contact:::Contact</link> section.  </li></ul>',
    },
  },
  {
    key: "q18",
  ...
  },
  {
    ...
    definition: {
      fr: "En contradiction avec les termes de la loi n° 2016-1321 of 7 octobre 2016 Pour une République numérique, toutes les données sur les financements publics de la recherche sur appel à projet ne sont pas accessibles. scanR valorise et intègre toutes les données auxquelles il accède.<br>Dans certains cas, l'information est accessible via des bases de données ou des API mises à disposition par le producteur de la donnée.<br>Dans d'autres cas, scanR ne dispose que de l'information diffusée de manière ouverte sur le site web de l'institution en charge du financement. Si les résultats d'une agence de financement n'y figure pas c'est que scanR n'a pas identifié la source ouverte associée ou n'accède pas à ces données ou que, compte tenu de la qualité de l'information disponible, le coût de traitement de l'information accessible est trop élevé.",
      en: "In contradiction with the terms of Law n° 2016-1321 of 7 October 2016 Pour une République numérique, not all data on public funding of research on a call for projects are accessible. scanR values and integrates all the data it accesses.<br>In some cases, the information is accessible via databases or APIs made available by the data producer.<br>In other cases, scanR only has access to information that is openly disseminated on the website of the funding institution.<br>If a funding agency's results are not included, it is because scanR does not access this data at all or, given the quality of the information available, the cost of processing is too high.",
    },
  },
  {
    key: "q20",
  ...
  },
  {
    ...
    definition: {
      fr: "Vous avez reçu un prix ou une distinction pour vos travaux de recherche mais scanR ne mentionne pas cette récompense ? Signalez-le nous [lien rubrique contact] et aidez nous à convaincre l'institution qui vous l'a décerné de verser régulièrement la liste de ses lauréats à scanR !<br>Votre entreprise, fondation, association, institution publique décerne des prix et distinctions à des acteurs de la recherche ? Vous souhaitez apparaître dans scanR pour renforcer la reconnaissance de votre action au côté de la recherche française ? <link>contact:::Contactez nous</link>   !",
      en: "You have received a scientific prize but scanR does not mention this award? Please let us know[link to contact section] and help us convince the institution that awarded you to regularly send the list of its winners to scanR!<br>Does your company, foundation, association, public institution award prizes and distinctions to research actors? Would you like to appear in scanR to strengthen the recognition of your action alongside French research?  <link>contact:::Contact us</link>  !",
    },
  },
  {
    key: "q25",
    ...
    definition: {
      ...
      en: 'The scientific prizes awarded to individuals are listed in the "People" pages. When the winner’s affiliation at the time of awarding the prize is known, scanR includes the prize at the level of the affiliated institution or lab. Unfortunately, this information is not always available.<br><link>contact:::Contact us</link> !',
    },
  },
  {
    key: "q26",
  ...
  },
  {
    ...
    definition: {
      fr: "scanR ne comporte pas de fiche auteur à votre nom alors que vous publiez ? Communiquez-nous votre nom, votre Idref ainsi que la liste des DOI de vos travaux et nous ajouterons une fiche-auteur à votre nom ! <link>contact:::Rendez-vous à la rubrique Contact !</link>  !",
      en: 'scanR does not have an author record in your name while you are publishing? Tell us your name, your Idref and the list of DOIs of your work and we will add an author profile to your name! <link>contact:::Go to the "Contact page"</link>  !',
    },
  },
  {
    key: "q29",
    ...
    definition: {
      ...
      en: "Do you no longer want to have an author profile in scanR?<br>Because scanR only refers to too little of your work? We can arrange this together. Contact us by copying and pasting the scanR address of your page from your browser, give us the list of DOIs of your publications or their HAL identifier or the reference in SUDOC or in theses.fr. We will handle it.<br>- For another reason, you no longer want your author profile to appear in scanR. In this case, we will delete your profile. However, your works will remain accessible via a search but they will no longer be associated with an author profile in your name.",
    },
  },
  {
    key: "q30",
    ...
    definition: {
      fr: "Via différentes sources (iLab, universités et établissement d'enseignement supérieur et de recherche ou d'organismes, veille, ...), scanR identifie certaines entreprises créées par les personnels d'un laboratoire ou utilisant les connaissances et technologies qui y sont développées. Ce repérage n'est pas exhaustif et s'améliorera grâce à vos retours et signalements ! <link>contact:::Contactez nous</link>  !",
      en: "Via different sources (iLab, universities and higher education and research institutions or organizations, monitoring,...), scanR identifies certain companies created by laboratory staff or using the knowledge and technologies developed in a laboratory. This tracking is not exhaustive and will improve thanks to your feedback and reports! <link>contact:::Contact us</link>  !",
    },
  },
  {
    key: "q31",
  ...
  },
  {
    ...
    definition: {
      ...
      en: 'scanR can reference a publication but be unable to link it to an author profile. Homonymies and lack of author-profile in the repositories are the main causes of this situation.<br>If you have a homonym, provide us with your idref identifier and, if possible, the list of DOIs for your work (or their Sudoc identifiers) and we will do the necessary.<br>If you do not have an Idref identifier, contact your correspondent "Scientific Information" in the university library or in your documentation centre. And at the same time, think about creating your international ORCID author ID and linking your ORCID profile to your new Idref ID!',
    },
  },
  {
    key: "q37",
    ...
    definition: {
      fr: "Pour couvrir l'ensemble des entités actives en matière de recherche et d'innovation en France, scanR s'appuie essentiellement sur 3 référentiels complémentaires : le Répertoire national des structures de recherche (RNSR) pour les laboratoires publics de recherche essentiellement, SIRENE pour les autres entités légales françaises et Grid pour les partenaires étrangers (déprécié d'ici à fin 2024 au profit de RoR).<br>La Base centrale des établissements est également mobilisée mais de manière beaucoup plus marginale pour les composantes des établissements d'enseignement supérieur qui n'ont pas d'existence juridique.",
      en: "To cover all entities active in research and innovation in France, scanR relies essentially on 3 complementary repositories: the Répertoire national des structures de recherche (RNSR) for public research laboratories, essentially, SIRENE for other French legal entities and Grid for foreign partners.<br>The Base centrale des établissements is also mobilized but in a much more marginal way for the sub-parts of higher education institutions that do not have a legal existence.<br>As these different repositories partially overlap, some scanR entities have different identifiers within these different repositories. At the margin, this partial recovery of the repositories leads to duplications that have not yet been detected. Help us find them by reporting them to us!",
    },
  },
  {
    key: "q38",
  ...
  },
  {
    ...
    definition: {
      fr: "scanR procède à une analyse automatisée des affiliations des auteurs mentionnées dans les publications qu'il couvre (la méthodologie est <link>https://hal.science/hal-03365806/:::présentée là</link> et le code est disponible sur <link>https://github.com/dataesr/affiliation-matcher:::github</link>). Cette analyse permet dans de nombreux cas d'associer, par le biais de ses publications, un auteur et une structure pour une année ou une période donnée. C'est de cette façon que sont calculées les 'Affiliations récentes' de scanR. Des erreurs sont possibles mais scanR peut les corriger. <link>contact:::Contactez-nous</link>!",
      en: "scanR carries out an analysis of the affiliations of the authors mentioned in the productions it covers. This analysis makes it possible to associate an author, an affiliation and a year of publication. The completeness of the tracking depends on scanR's ability to associate free text on a production with an entity referenced in scanR. Errors are possible but scanR can correct them. <link>contact:::Contact us</link> ",
    },
  },
  {
    key: "q42",
  ...
  },
  {
    ...
    definition: {
      fr: "Les inventions correspondent ici aux familles de brevets simples au sens de l’OEB. Une famille de brevets simple est une collection de dépôts de brevets considérés comme couvrant une seule invention : leur contenu technique est réputé identique et ils ont tous exactement les mêmes priorités.<br>En effet, un brevet ne protégeant que sur un territoire déterminé, il est nécessaire de déposer une demande de brevet dans toutes les juridictions où l'on souhaite être protégé. Des procédures facilitent la démarche, mais au final elles donnent lieu à un ensemble de dépôts dans divers offices nationaux ou régionaux, que l'on regroupe dans ce que l'on appelle la famille de brevets.<br><link>https://www.epo.org/searching-for-patents/helpful-resources/first-time-here/patent-families_fr.html:::En savoir plus sur les familles de brevets</link>",
      en: "The inventions here mean EPO’s simple patent families. A simple patent family is a collection of patent documents that are considered to cover a single invention : their technical content is considered to be identical and they all have exactly the same priorities.<br>Indeed, patent protection is territorial and inventors and investors may have to seek protection in various different jurisdictions. Procedures facilitate the process, but ultimately they give rise to a set of filings in various national or regional offices, which are grouped in what is called the patent family.<br><link>https://www.epo.org/searching-for-patents/helpful-resources/first-time-here/patent-families_fr.html:::Learn more about patent families</link>",
    },
  },
  {
    key: "q46",
  ...
  },
  {
    ...
    definition: {
      fr: "Deux sources sont utilisées pour alimenter les données sur les dépôts de brevets : la base de données Patstat de l'OEB ( Organisation européenne des brevets) et les données de l'INPI (Institut National de la Propriété Industrielle).<br>PATSTAT contient des données bibliographiques sur plus de 100 millions de documents brevets provenant de grands pays industrialisés et en développement. Ces données sont extraites des base de données de l'OEB.<br>Les données source de l'INPI proviennent quant à elles des fichiers XML de création et mise à jour des dossiers de dépôts de brevets à l'INPI ainsi que des fichiers de traductions en français des résumés de demandes de brevets déposés à l'OEB en anglais ou allemand.",
      en: "Two sources are used to provide data on patent filings: the EPO Patstat database (European Patent Office) and the INPI (National Institute of Industrial Property) data.<br>PATSTAT contains bibliographical data relating to more than 100 million patent documents from leading industrialised and developing countries. It also includes the legal status data from more than 40 patent authorities contained in the EPO worldwide legal status database.<br>The INPI's source data comes from XML files for creating and updating patent applications at INPI as well as French translation files for abstract of patent applications filed at the EPO in English or German.",
    },
  },
  {
    key: "q53",
  ...
  },
  {
    ...
    definition: {
      fr: "Une demande de brevet nationale est effectuée au sein d'un office national et délivre des brevets  protégeant sur le territoire national.<br>Le PCT est un traité international qui compte plus de 150 États contractants. Ce traité permet d’obtenir simultanément la protection d’une invention dans un grand nombre de pays en déposant une demande “internationale” unique au lieu de déposer plusieurs demandes de brevet nationales ou régionales distinctes. La délivrance des brevets reste sous le contrôle des offices de brevets nationaux ou régionaux dans ce qu’il est convenu d’appeler la “phase nationale”.<br>Une demande régionale est une demande effectuée auprès d'un office régional : la demande peut être effectuée directement auprès de l'office régional ou bien elle est faite par désignation lors de la procédure du PCT.<br><link>https://www.wipo.int/pct/en/faqs/faqs.html:::En savoir plus sur la procédure PCT</link>",
      en: "A national patent application is filed at a national office and grants patents protecting on the national territory.<br>The PCT is an international treaty with more than 150 Contracting States. The PCT makes it possible to seek patent protection for an invention simultaneously in a large number of countries by filing a single “international” patent application instead of filing several separate national or regional patent applications. The granting of patents remains under the control of the national or regional patent Offices in what is called the “national phase”.<br>A regional application is an application filed with a regional office: the application may be filed directly with the regional office or it may be filed by designation during the PCT procedure.<br><link>https://www.wipo.int/pct/en/faqs/faqs.html:::Learn more about the International Patent System</link>",
    },
  },
  {
    key: "q55",
    ...
    icon: "fas fa-question-circle",
    label: {
      fr: "Qu'est-ce que le programme Horizon Europe ?",
      en: "What is the Horizon Europe program?",
    },
    definition: {
      ...
      en: 'Horizon Europe is the European programme to support Research, Development and Innovation (RDI). It integrates the former FP7, the European Institute of Innovation and Technology and the innovation actions of the Competitiveness and Innovation Framework Programme (CIP). It is mainly structured around 3 main "Pillars": "Scientific excellence" oriented more fundamental research, "Industrial primacy" and "Societal challenges" oriented more applicative. It is implemented mainly through collaborative and European projects, but it is possible for innovative SMEs to obtain individual financing.<br>The H2020 programme has a budget of €80 billion for the period 2014 - 2020<br><link>https://bit.ly/2LKOWW6:::Learn more about H2020</link><br><link>https://bit.ly/38qctFD:::Learn more about Work Programmes</link>',
    },
  },
  {
    key: "q56",
    ...
    definition: {
      fr: "Le moteur de recherche indexe le contenu des différents objets de scanR. Ce contenu, suivant les sources et les objets peut-être en français ou en anglais. Il est donc recommandé, notamment pour les recherches liées à une thématique, d'effectuer une recherche bilingue. Cela peut se faire grâce à l'opérateur \"|\" (ou) (cf FAQ <linkQuestion>q11:::Comment affiner une recherche avec des opérateurs ?</linkQuestion>)",
      en: 'The search engine indexes the content of the different scanR objects. This content, depending on the sources and objects, may be in French or English. It is therefore recommended, particularly for research related to a theme, to conduct a bilingual research. This can be done using the operator "|" (or) (see question <linkQuestion>q11:::How to refine a search with operators?</linkQuestion>)',
    },
  },
  {
    key: "q57",
  ...
  },
  {
    ...
    definition: {
      fr: "Les réseaux sont construits à partir des publications de recherche de scanR. <ul><li> <h3>Collecte des publications</h3> scanR recherche toutes les publications liées à une requête spécifique de l'utilisateur.</li> <li><h3>Agrégation des publications</h3> Les publications obtenues sont agrégées en fonction du modèle de réseau : <ul><li><b>Modèle 'Auteurs' </b><br>Les nœuds représentent les auteurs, et les arêtes indiquent le nombre de co-publications entre deux auteurs. </li> <li><b>Modèle 'Etablissements'</b><br>Les nœuds représentent les établissements, et les arêtes représentent le nombre de co-publications entre deux établissements. </li> <li><b>Modèle 'Laboratoires'</b><br>Les nœuds représentent les laboratoires, et les arêtes indiquent le nombre de co-publications entre deux laboratoires. </li> <li><b>Modèle 'Thématiques'</b><br>Les nœuds représentent les thématiques, et les arêtes indiquent le nombre de co-publications entre deux thématiques. </li> <li><b>Modèle 'Logiciels' </b><br>Les nœuds représentent les logiciels, et les arêtes représentent le nombre de co-publications entre deux logiciels. </li> <li><b>Modèle 'Projets' </b><br>Les nœuds représentent des projets, et les arêtes représentent le nombre de co-publications entre deux projets.</li><li><b>Modèle 'Pays'</b><br>Les nœuds représentent les pays, et les arêtes représentent le nombre de co-publications entre deux pays. </li> </ul></li> <li><h3>Filtrage des données</h3>  Pour assurer la pertinence du réseau, scanR filtre les nœuds pour ne conserver que les plus pertinents, limitant un réseau aux 300 nœuds les plus importants et/ou aux 5 composantes principales au maximum. </li></ul>",
      en: "The networks are built from research publications from scanR. <ul><li> <h3>Collection of publications</h3> scanR searches for all publications related to a specific user query.</li> <li><h3>Aggregation of publications</h3> The obtained publications are aggregated according to the network model: <ul><li><b>'Authors' model</b><br>Nodes represent authors, and edges indicate the number of co-publications between two authors.</li> <li><b>'Institutions' model</b><br>Nodes represent institutions, and edges represent the number of co-publications between two institutions.</li> <li><b>'Structures' model</b><br>Nodes represent laboratories, and edges indicate the number of co-publications between two laboratories.</li> <li><b>'Themes' model</b><br>Nodes represent themes, and edges indicate the number of co-publications between two themes.</li> <li><b>'Software' model</b><br>Nodes represent software, and edges represent the number of co-publications between two software.</li> <li><b>'Projects' model</b><br>Nodes represent projects, and edges represent the number of co-publications between two projects.</li> <li><b>'Countries' model</b><br>Nodes represent countries, and edges represent the number of co-publications between two countries.</li></ul></li> <li><h3>Data Filtering</h3> To ensure the relevance of the network, scanR filters the nodes to keep only the most relevant ones, limiting a network to the top 300 most important nodes and/or up to 5 main components at maximum. </li></ul>",
    },
  },
  {
    key: "q59",
    ...
    definition: {
      fr: "En <link>https://fr.wikipedia.org/wiki/Th%C3%A9orie_des_graphes:::théorie des graphes</link>, une communauté correspond à un ensemble de nœuds dans un graphe qui sont fortement interconnectés entre eux, tout en étant moins connectés avec les nœuds situés à l'extérieur de cette communauté. Les communautés peuvent être identifiées dans le but de comprendre la structure et les motifs sous-jacents du graphe, ainsi que pour analyser les relations et les interactions entre les entités qui le composent.<br>Pour identifier les communautés nous utilisons <link>https://fr.wikipedia.org/wiki/M%C3%A9thode_de_Louvain:::la méthode de Louvain</link>. Cet algorithme fonctionne en optimisant une mesure de modularité qui évalue la force des communautés dans un graphe. Plus précisément, Louvain cherche à maximiser la modularité en déplaçant progressivement les nœuds d'un graphe dans des communautés différentes, de manière itérative.<br>À chaque étape, il fusionne les communautés voisines si cela conduit à une amélioration de la modularité globale du graphe. Ce processus itératif se poursuit jusqu'à ce qu'aucun mouvement supplémentaire ne puisse augmenter la modularité.",
      en: "In <link>https://en.wikipedia.org/wiki/Graph_theory:::graph theory</link>, a community corresponds to a set of nodes in a graph that are strongly interconnected with each other, while being less connected to nodes outside of this community. Communities can be identified in order to understand the structure and underlying patterns of the graph, as well as to analyze the relationships and interactions between the entities that compose it.<br>To identify communities, we use <link>https://en.wikipedia.org/wiki/Louvain_method:::the Louvain method</link>. This algorithm works by optimizing a measure of modularity that evaluates the strength of communities in a graph. More precisely, Louvain seeks to maximize modularity by progressively moving nodes in a graph to different communities, iteratively.<br>At each step, it merges neighboring communities if it leads to an improvement in the overall modularity of the graph. This iterative process continues until no further movement can increase modularity.",
    },
  },
  {
    key: "q60",
    ...
    definition: {
      fr: "Pour nommer les communautés nous utilisons de l'IA générative de <link>https://mistral.ai:::Mistral AI</link> (modèle 'mistral-nemo').<br>Les noms sont obtenus à partir des principales thématiques des publications collectées pour chaque communauté.<br>Dans un souci de performance nous nous limitons pour le moment aux 2000 publications les plus pertinentes (par rapport à la recherche de l'utilisateur) pour chaque communauté. ",
      en: "To name the communities, we use generative AI from <link>https://mistral.ai:::Mistral AI</link> (model 'mistral-nemo').<br>The names are derived from the main themes of the publications collected for each community.<br>For performance reasons, we are currently limiting ourselves to the 2,000 most relevant publications (in relation to the user's search) for each community. ",
    },
  },
  {
    key: "q61",
    ...
    definition: {
      fr: "<link>https://www.vosviewer.com:::VosViewer</link> est un logiciel développé par <link>https://www.cwts.nl:::CWTS</link> (<link>https://www.universiteitleiden.nl/en:::Université de Leiden</link>), spécialisé dans la visualisation et l'analyse de réseaux, particulièrement utilisé dans le domaine de la recherche scientifique.<br>Nous utilisons cet outil pour visualiser les réseaux de manière interactive, offrant ainsi une compréhension approfondie des structures et des tendances au sein de vastes ensembles de données bibliographiques.",
      en: "<link>https://www.vosviewer.com:::VOSviewer</link> is a software developed by <link>https://www.cwts.nl:::CWTS</link> (<link>https://www.universiteitleiden.nl/en:::Leiden University</link>), specialising in the visualisation and analysis of networks, particularly used in the field of scientific research. We use this tool to visualise networks interactively, providing a thorough understanding of structures and trends within large bibliographic datasets.",
    },
  },
  {
    key: "q62",
    ...
    definition: {
      fr: "Pour les entreprises privées qui ne disposent pas de description nous utilisons l'IA générative de <link>https://mistral.ai:::Mistral AI</link>.<br>À partir du contenu du site web de l'entreprise, nous demandons à Mistral de nous faire un résumé de ses principales activités.",
      en: "For private companies that do not have a description, we use generative AI from <link>https://mistral.ai:::Mistral AI</link>.<br>Based on the content from the company's website, we ask Mistral to provide us with a summary of its main activities.",
    },
  },
  {
    key: "q63",
    ...
    definition: {
      fr: "Le diagramme stratégique, également connu sous le nom de quadrant de Callon, est un outil d'analyse bibliométrique permettant de positionner les communautés d'un réseau selon deux axes : la <b>centralité</b> (axe horizontal) et la <b>densité</b> (axe vertical).<imgInsert>/img/callon_quadrants_3.png:::Representation d'un diagramme stratégique</imgInsert> Ce diagramme divise l'espace en quatre quadrants permettant d'identifier le rôle stratégique de chaque communauté dans le réseau : les thèmes moteurs, les thèmes de niche, les thèmes basiques et transversaux, et les thèmes émergents ou en déclin.<br>Cette visualisation aide à comprendre la structure thématique d'un domaine de recherche et son évolution.<br><linkQuestion>q64:::Comment sont calculées la densité et la centralité des communautés ?</linkQuestion><br><linkQuestion>q65:::Comment interpréter le diagramme stratégique ?</linkQuestion>",
      en: "The strategic diagram, also known as the Callon quadrant, is a bibliometric analysis tool used to position network communities along two axes: <b>centrality</b> (horizontal axis) and <b>density</b> (vertical axis).<imgInsert>/img/callon_quadrants_3.png:::Representation of a strategic diagram</imgInsert> This diagram divides the space into four quadrants to identify the strategic role of each community in the network: motor themes, niche themes, basic and transversal themes, and emerging or declining themes.<br>This visualization helps understand the thematic structure of a research field and its evolution.<br><linkQuestion>q64:::How are community density and centrality calculated?</linkQuestion><br><linkQuestion>q65:::How to interpret the strategic diagram?</linkQuestion>",
    },
  },
  {
    key: "q64",
  ...
  },
  {
    ...
    icon: "fas fa-question-circle",
    label: {
      fr: "Comment interpréter le diagramme stratégique ?",
      en: "How to interpret the strategic diagram?",
    },
    definition: {
      fr: "<imgInsert>/img/callon_quadrants.png:::Les quatres quadrants du diagramme stratégique</imgInsert>Le diagramme stratégique est centré sur les médianes de centralité et de densité, ce qui divise naturellement l'espace en quatre quadrants :<br><ul><li><b>Thèmes moteurs (en haut à droite)</b><br>Haute centralité, haute densité. Ces thèmes sont à la fois bien développés en interne et centraux dans le réseau. Ils représentent les axes de recherche principaux et structurants du domaine.</li><br><li><b>Thèmes de niche ou isolés (en haut à gauche)</b><br>Basse centralité, haute densité. Ces thèmes sont très développés en interne mais peu connectés au reste du réseau. Ils peuvent représenter des domaines spécialisés ou des thématiques périphériques bien établies.</li><br><li><b>Thèmes émergents ou en déclin (en bas à gauche)</b><br>Basse centralité, basse densité. Ces thèmes sont peu développés et peu connectés. Ils peuvent correspondre à des sujets émergents en cours de structuration ou à des thématiques en déclin.</li><br><li><b>Thèmes basiques et transversaux (en bas à droite)</b><br>Haute centralité, basse densité. Ces thèmes sont centraux dans le réseau mais moins développés en interne. Ils constituent souvent des fondements méthodologiques ou des thèmes transversaux qui irriguent plusieurs domaines.</li></ul><br><h3>Interprétation visuelle du diagramme stratégique</h3><imgInsert>/img/callon_quadrants_1.png:::Catégorie 1: Cette configuration reflète un domaine mature et stable. La majorité de l'activité de recherche gravite autour d'un ensemble limité de thèmes centraux et fortement structurés.</imgInsert><imgInsert>/img/callon_quadrants_2.png:::Catégorie 2: Les thèmes sont organisés de manière irrégulière, avec peu de convergence vers une structure dominante. Le domaine apparaît polycentrique et dynamiquement évoluant.</imgInsert><imgInsert>/img/callon_quadrants_3.png:::Catégorie 3: Cette configuration est charactérisée une structure riche et complexe, avec tous les degrés de developpement présents et suggère une dynamique importante du domaine.</imgInsert>",
      en: "<imgInsert>/img/callon_quadrants.png:::The four quadrants of the strategic diagram</imgInsert>The strategic diagram is centered on the medians of centrality and density, which naturally divides the space into four quadrants:<br><ul><li><b>Motor themes (top right)</b><br>High centrality, high density. These themes are both well-developed internally and central in the network. They represent the main and structuring research axes  of the field.</li><br><li><b>Niche or isolated themes (top left)</b><br>Low centrality, high density. These themes are highly developed internally but poorly connected to the rest of the network. They may represent specialized domains or well-established peripheral topics.</li><br><li><b>Emerging or declining themes (bottom left)</b><br>Low centrality, low density. These themes are underdeveloped and poorly connected. They may correspond to emerging subjects in the process of structuring or to declining themes.</li><br><li><b>Basic and transversal themes (bottom right)</b><br>High centrality, low density. These themes are central in the network but less developed internally. They often constitute methodological foundations or cross-cutting themes that permeate several domains.</li></ul><br><h3>Interpretation of the strategic diagram</h3><imgInsert>/img/callon_quadrants_1.png:::Category 1: This configuration reflects a mature and stable domain. Most of the research activity gravitates around a limited set of central and strongly structured themes.</imgInsert><imgInsert>/img/callon_quadrants_2.png:::Category 2: Themes are unevenly organized, with little convergence toward a dominant structure. The field appears polycentric and dynamically evolving.</imgInsert><imgInsert>/img/callon_quadrants_3.png:::Category 3: This configuration characterizes a complex and rich domain with multiple levels of thematic development. No single structure dominates the organization of research.</imgInsert>",
    },
  },
  {
    key: "q66",
