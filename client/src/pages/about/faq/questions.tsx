export const questions = [
  ...
  },
  {
    ...
    definition: {
      ...
      en: 'scanR focuses on 4 main types of "Objects": <b>entities</b>, <b>projects</b>, <b>persons</b> and <b>productions</b> (publications, PhD thesis and patents).\nAmong the "entities", scanR covers all the research structures referenced in the National Directory of Research Structures (RNSR) as well as their institutions. It also covers, in the most comprehensive way possible, all public or private institutions, whether profit-making or not, mentioned in the main sources mobilized.\nscanR covers a set of "Projects" that correspond to research works that have been the subject of French public funding or not insofar as an open and reusable source exists (see FAQ <linkQuestion>q18:::What are the funding identified in scanR?</linkQuestion>).\nscanR covers authors with an Idref identifier (see FAQ <linkQuestion>q27:::Which authors have an author profile in scanR?</linkQuestion>) for whom at least one link to another source (RNSR, production, project) could be established. To avoid errors, scanR excludes homonymous authors. On request and with additional information, scanR can introduce them individually.\nscanR covers publications (see FAQ <linkQuestion>q31:::What is the scope of research publications (articles, theses, monographs) presented in scanR?</linkQuestion>) since 2013, a selection of books and monographs, theses since 1990, patents since 2013.',
    },
  ...
  },
  {
    ...
    definition: {
      fr: "Deux solutions pour contribuer à l'amélioration de scanR : \n <ul><li>Vous avez identifié une erreur, une omission sur une fiche entité, auteur, production ou financement particulière ? Utilisez le bouton \"Contribuer\" pour nous contacter !\n </li> <li>Des remarques générales sur scanR, des idées de sources à intégrer, de propositions d'évolutions de l'interface, des envies de partenriats et de collaboration avec l'équipe ? Rendez-vous à la rubrique <link>contact:::Contact</link>. </li></ul>",
      en: 'Two solutions to contribute to the improvement of scanR: \n <ul><li> Have you identified an error or omission on a particular entity, author, production or funding record? Use the "Contribute" button to contact us !\n </li> <li>General remarks on scanR, ideas of sources to integrate, proposals for evolutions of the interface, desires of partnerships and collaboration with the team? Go to the <link>contact:::Contact</link> section.  </li></ul>',
    },
  },
  {
    key: "q18",
  ...
  },
  {
    ...
    definition: {
      fr: "Vous avez reçu un prix ou une distinction pour vos travaux de recherche mais scanR ne mentionne pas cette récompense ? Signalez-le nous [lien rubrique contact] et aidez nous à convaincre l'institution qui vous l'a décerné de verser régulièrement la liste de ses lauréats à scanR !\nVotre entreprise, fondation, association, institution publique décerne des prix et distinctions à des acteurs de la recherche ? Vous souhaitez apparaître dans scanR pour renforcer la reconnaissance de votre action au côté de la recherche française ? <link>contact:::Contactez nous</link>   !",
      en: "You have received a scientific prize but scanR does not mention this award? Please let us know[link to contact section] and help us convince the institution that awarded you to regularly send the list of its winners to scanR!\nDoes your company, foundation, association, public institution award prizes and distinctions to research actors? Would you like to appear in scanR to strengthen the recognition of your action alongside French research?  <link>contact:::Contact us</link>  !",
    },
  },
  {
    key: "q25",
